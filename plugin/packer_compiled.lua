...
_G.packer_plugins = {
  ...
  ["barbecue.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/adi/.local/share/nvim/site/pack/packer/opt/barbecue.nvim",
  ...
  ["dashboard-nvim"] = {
    loaded = true,
    path = "/home/adi/.local/share/nvim/site/pack/packer/start/dashboard-nvim",
  ...
  ["nvim-navic"] = {
    loaded = true,
    path = "/home/adi/.local/share/nvim/site/pack/packer/start/nvim-navic",
